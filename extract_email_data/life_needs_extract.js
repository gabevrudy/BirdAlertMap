...
function extractEmailBodyAsJson() {
    var query = 'subject:"[eBird Alert] Needs Alert for San Luis Obispo County <daily>" newer_than:1d';
  ...
  function saveJsonToDrive(jsonString, email_date) {
    ...
    var fileName = "Needs_" + formattedDate + ".geojson";
    var folder = DriveApp.getFolderById("1qNBXN5f20gpwQYLGTPmlQynodMQSx67K"); // Specify your folder ID
