//Function to get ABA Alerts from Email and save to Drive as JSON
//Trigger: Once a day

function extractEmailBodyAsJson() {
    var query = 'subject:"[eBird Alert] ABA Rarities <daily>" newer_than:1d';
  ...
  function saveJsonToDrive(jsonString, email_date) {
    ...
    var fileName = "ABA_" + formattedDate + ".geojson";
